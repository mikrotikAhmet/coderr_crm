...
class Migration_Version_105 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if(!update_config_installed()){
            echo '<div style="color:red;">Failed to update config installed to true. Please update menualy in application/config/config.php. This can happen if config.php dont have writable permissions.</div>';
        }
    }
}

    ...
    <div class="col-md-12">
        <div class="col-md-3">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="control-label" for="processor-member-id">Member ID</label>
                    <input type="text" name="processor_data[memberId]" id="processor-member-id" class="form-control" value=""/>
                </div>
                <div class="form-group">
                    <label class="control-label" for="processor-member-guid">Member GUID</label>
                    <input type="text" name="processor_data[memberGuid]" id="processor-member-guid" class="form-control" value=""/>
                </div>
            </fieldset>
        </div>
        <div class="col-md-3">

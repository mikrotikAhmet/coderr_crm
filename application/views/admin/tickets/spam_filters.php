...
<script>
  $(document).ready(function(){
   initDataTable('.table-sender', window.location.href + '/sender', 'filters', [1], [1]);
   initDataTable('.table-subject', window.location.href + '/subject', 'filters', [1], [1]);
   initDataTable('.table-phrase', window.location.href + '/phrase', 'filters', [1], [1]);

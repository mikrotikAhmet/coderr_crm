            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <a href="<?php echo admin_url()?>currencies/update_currency" class="btn btn-default pull-right"><i class="fa fa-refresh"></i> Refresh</a>
                    </div>
                </div>
                <div class="panel_s">
                    <div class="panel-body">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('value','currency_add_edit_value'); ?>
                        <?php echo render_input('decimal_place','currency_add_edit_decimal'); ?>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $('#currency_modal').on('show.bs.modal', function(event) {
        ...
        var decimal_place = button.data('decimal');
        ...
        if (typeof(id) !== 'undefined') {
            ...
            var value = $(button).parents('tr').find('td').eq(2).text();
            ...
            $('#currency_modal input[name="value"]').val(value);
            $('#currency_modal input[name="decimal_place"]').val(decimal_place);
        }
    });

	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				<?php if(has_customer_permission('gateway')){ ?>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu animated fadeIn">
						<?php if(has_customer_permission('terminal')){ ?>
							<li><a href="<?php echo site_url('terminal'); ?>">3D-Secure Virtual Terminal</a></li>
						<?php } ?>
						<?php if(has_customer_permission('batch')){ ?>
							<li><a href="<?php echo site_url('batch'); ?>">Batching Terminal</a></li>
						<?php } ?>
						<li class="divider"></li>
						<?php if(has_customer_permission('gateway')){ ?>
							<li><a href="<?php echo site_url('transactions'); ?>">Transactions</a></li>
							<li><a href="<?php echo site_url('clients/balance'); ?>">Account Balance</a></li>
						<?php } ?>
						<li class="divider"></li>
						<?php if(has_customer_permission('terminal')){ ?>
							<li><a href="<?php echo site_url('batch/processor'); ?>">Batch Processor</a></li>
						<?php } ?>
						<?php if(has_customer_permission('batch')){ ?>
							<li><a href="<?php echo site_url('batch/batch_list'); ?>">Batch List</a></li>
						<?php } ?>
					</ul>
				</li>
				<?php } ?>
				<?php if(has_customer_permission('relay')){ ?>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							Relay
							<span class="caret"></span></a>
...
<!--								<li><a href="--><?php //echo site_url('account/settings'); ?><!--">Account Settings</a></li>-->
								...
								<?php } ?>
<!--								<li><a href="--><?php //echo site_url('events'); ?><!--">Events & Webhooks</a></li>-->

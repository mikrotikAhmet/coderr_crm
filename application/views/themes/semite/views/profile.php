...
<div class="col-md-4">
	<div class="panel_s">
		...
		<div class="panel-body">
			<div class="form-group">
				<label for="api_id" class="control-label">Api Id</label>
				<input type="text" id="api_id" name="api_id" class="form-control" value="<?php echo $merchant->api_id?>" style="pointer-events: none; ">
			</div>
			<div class="form-group">
				<label for="api_id" class="control-label">Secret Key</label>
				<input type="text" id="secret_key" name="secret_key" class="form-control" value="<?php echo $merchant->secret_key?>" style="pointer-events: none; ">
			</div>
		</div>
	</div>

	<button data-link="<?php echo site_url('clients/api_access'); ?>" class="btn btn-default generate_api_access pull-right" onclick="generateAccess(this);return false;">Generate API Access Keys&nbsp;&nbsp;<i class="fa fa-refresh api_access_spinner"></i></button>
